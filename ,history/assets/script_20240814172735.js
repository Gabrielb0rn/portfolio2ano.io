...
function toggleMateria(materia) {
    const contents = document.querySelectorAll('.materia-content');
    contents.forEach(content => content.style.display = 'none');
    document.getElementById(materia).style.display = 'block';
}

// Inicia com todas as matérias escondidas
document.addEventListener('DOMContentLoaded', function() {
    const contents = document.querySelectorAll('.materia-content');
    contents.forEach(content => content.style.display = 'none');
});
function toggleMateria(materiaId) {
    const materias = document.getElementsByClassName('materia-content');
    for (let i = 0; i < materias.length; i++) {
        materias[i].style.display = 'none';
    }
    const selectedMateria = document.getElementById(materiaId);
    if (selectedMateria) {
        selectedMateria.style.display = 'block';
    }
}
function toggleMateria(materiaId) {
    var contents = document.getElementsByClassName('materia-content');
    for (var i = 0; i < contents.length; i++) {
        contents[i].style.display = 'none';
    }
    var selectedContent = document.getElementById(materiaId);
